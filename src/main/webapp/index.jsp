                ...
                <div class="card bg-light text-black rounded border border-5 border-orange col-12 col-md-8 col-lg-6 col-xl-5">
					...
					<form action="LoginServlet">
                        ...
                        <div class="form-outline form-white my-4">
                            <input type="text" placeholder="CPF" id="textCpf" class="text-varche form-control form-control-md border border-3 border-orange" name="cpf" />
                        </div>

                        <div class="form-outline form-white mb-4 ">
                            <input type="password" placeholder="Senha" id="text" class="text-varche form-control form-control-md border border-3 border-orange" name="senha"/>
                        </div>
